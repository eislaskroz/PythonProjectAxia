...
CATALOGO_MATERIALES_POR_ESPECIALIDAD = {
    ...
    "Redes Voz y Datos": [
        ...
        _m("Canaleta PVC", "Canalización", "Tramo(s)", "Medida y color"),
        _m("Tubería y canalización eléctrica", "Canalización", "Tramo(s)", "Tipo y diámetro"),
    ...
    "Plantas de Energía": [
        ...
        _m("Tubería pared delgada", "Canalización", "Tramo(s)", "Diámetro"),
        _m("Cinta aislante", "Aislamiento", "Rollo(s)", "Grado eléctrico"),
    ...
    "Electricidad": [
        ...
        _m("Conectores para tubería", "Canalización", "Pieza(s)", "Tipo y diámetro"),
    ...
    "Tecnología, Equipos y Periféricos": [
        _m("Cinchos plásticos", "Sujeción", "Paquete(s)", "Longitud y color"),
        _m("Velcro para cableado", "Sujeción", "Rollo(s)", "Ancho y longitud"),
        _m("Tornillos para gabinete/equipo", "Fijación", "Caja(s)", "Tipo y medida"),
        _m("Taquetes y pijas", "Fijación", "Caja(s)", "Medida según superficie"),
        _m("Cable de alimentación", "Energía", "Pieza(s)", "Tipo de conector y longitud"),
        _m("Extensión eléctrica", "Energía", "Pieza(s)", "Calibre, longitud y contactos"),
        _m("Multicontacto regulado", "Energía", "Pieza(s)", "Número de salidas y protección"),
        _m("Cable de red", "Conectividad", "Metro(s)", "Cat5e/Cat6, interior o exterior"),
        _m("Patch cord", "Conectividad", "Pieza(s)", "Categoría, longitud y color"),
        _m("Conectores RJ45", "Conectividad", "Caja(s)", "Categoría y blindaje"),
        _m("Cable USB", "Conectividad", "Pieza(s)", "Tipo A/B/C y longitud"),
        _m("Cable HDMI/DisplayPort", "Video", "Pieza(s)", "Tipo, versión y longitud"),
        _m("Adaptadores y convertidores", "Conectividad", "Pieza(s)", "Entradas y salidas"),
        _m("Pasta térmica", "Mantenimiento", "Pieza(s)", "Presentación y conductividad"),
        _m("Aire comprimido", "Mantenimiento", "Bote(s)", "Presentación"),
        _m("Limpiador de contactos", "Mantenimiento", "Bote(s)", "Uso electrónico"),
        _m("Etiquetas para activos y cableado", "Identificación", "Paquete(s)", "Tipo y medida"),
        _m("Canaleta para cableado", "Canalización", "Tramo(s)", "Medida y color"),
    ],
    "Paneles Solares": [

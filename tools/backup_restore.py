...
TABLES = {
    ...
    "db_clientes_sucursales": ("suc_id", "suc_id,id_cliente,suc_nombre,suc_domicilio,suc_telefono,suc_correo,suc_estado,suc_municipio,suc_estatus,fecha_registro"),
    ...
    "db_ordenes_trabajo": ("id_orden", "id_orden,ot_aco_numero,ot_actividad,ot_asunto,ot_cliente,ot_contacto,ot_descripcion,ot_esi,ot_estatus,ot_fecha,ot_fecha_programada,ot_folio,ot_jefe_operacion,ot_numero_dias,ot_numero_personas,ot_partidas_json,ot_prioridad,ot_sucursal,ot_supervisor,ot_tecnico,fecha_registro"),
    "db_bitacoras": ("id_bitacora", "id_bitacora,bit_aco_numero,bit_avance,bit_cliente,bit_descripcion,bit_direccion_sucursal,bit_encargado_proyecto_axia,bit_estatus,bit_fecha,bit_folio,bit_hora_llegada,bit_hora_salida,bit_observaciones,bit_porcentaje_avance,bit_tecnico,bit_tecnico_sitio,fecha_registro"),
